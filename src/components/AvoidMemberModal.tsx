      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <div className="bg-[#f8dfc0]/60 border border-[#f8dfc0] rounded-2xl p-3 mb-4">
              <p className="text-xs text-[#6e5c44] font-medium leading-relaxed">
                <strong>A evitar</strong> penaliza fortemente no plano, mas não exclui 100%. O ingrediente só aparece se for mesmo necessário.
              </p>
            </div>
